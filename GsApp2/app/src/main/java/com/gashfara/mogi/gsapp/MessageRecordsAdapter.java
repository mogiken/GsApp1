    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        buttonView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("nowmogi","id:"+messageRecord.getId()+":"+messageRecord.getComment());
                //uriから空のデータを作成
                    ...
                    public void onSaveCompleted(int token, KiiObject object, Exception exception) {
                        if (exception != null) {
                            ...
                            if (exception instanceof CloudExecutionException)
                                ...
                                Log.d("now1",Util.generateAlertMessage((CloudExecutionException) exception));
                            else
                                //一般的なエラーを表示
                                Log.d("now1", exception.getLocalizedMessage());
